...
def log_cluster_incident(resource_name: str, namespace: str, severity: str, issue: str) -> dict:
    """
    ...
    """
    log.info("incident.logged.by.agent", resource=resource_name, namespace=namespace, severity=severity)
